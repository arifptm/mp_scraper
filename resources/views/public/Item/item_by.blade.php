			...
			<div class="col-xs-6 col-sm-4 col-md-3">		
				<div class="card">
					<div class="card-image">				
						<a href="/{{ $item->slug }}"><img class="b-lazy img-responsive marginauto" src=data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw== data-src="{{ unserialize($item->images)[0] }}" alt="gambar {{ $item->title }}"  /></a>
					</div>
